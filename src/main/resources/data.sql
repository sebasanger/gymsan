...
(1, DATE_SUB(CURRENT_TIMESTAMP, INTERVAL 30 DAY), 50000, "kjkszpj", true, "pago de la mensualidad e inscripcion", 2);
-- PAGOS --
...
-- POGRESOS EJERCICIOS --
insert into progresos_ejercicios (id, progresos_rutinas_id, ejercicios_id, cantidad_series) values (1, 1, 1, 4), (2, 2, 2, 4), (3, 3, 3, 4);
-- POGRESOS EJERCICIOS --
